...
import { createTha, getCurrentTha } from "../../actions/thaActions";
...
class CreateTha extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.tha.tha) {
      const tha = nextProps.tha.tha;

      const MeightonineCSV = tha.Meighttoone.join(",");

      MeightonineCSV = !isEmpty(MeightonineCSV) ? MeightonineCSV : "";

      this.setState({
        Meighttonine: MeightonineCSV
      });
    }
  }
