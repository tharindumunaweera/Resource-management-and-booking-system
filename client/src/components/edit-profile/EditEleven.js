...
import { createEleven, getCurrentEleven } from "../../actions/elevenActions";
...
class CreateEleven extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.eleven.eleven) {
      const eleven = nextProps.eleven.eleven;

      const MeleventotwelveCSV = eleven.Meleventotwelve.join(",");
      const MeleventooneCSV = eleven.Meleventoone.join(",");
      const MeleventotwoCSV = eleven.Meleventotwo.join(",");
      const MeleventothreeCSV = eleven.Meleventothree.join(",");
      const MeleventofourCSV = eleven.Meleventofour.join(",");
      const MeleventofiveCSV = eleven.Meleventofive.join(",");

      const TeleventotwelveCSV = eleven.Televentotwelve.join(",");
      const TeleventooneCSV = eleven.Televentoone.join(",");
      const TeleventotwoCSV = eleven.Televentotwo.join(",");
      const TeleventothreeCSV = eleven.Televentothree.join(",");
      const TeleventofourCSV = eleven.Televentofour.join(",");
      const TeleventofiveCSV = eleven.Televentofive.join(",");

      const WeleventotwelveCSV = eleven.Weleventotwelve.join(",");
      const WeleventooneCSV = eleven.Weleventoone.join(",");
      const WeleventotwoCSV = eleven.Weleventotwo.join(",");
      const WeleventothreeCSV = eleven.Weleventothree.join(",");
      const WeleventofourCSV = eleven.Weleventofour.join(",");
      const WeleventofiveCSV = eleven.Weleventofive.join(",");

      const THeleventotwelveCSV = eleven.THeleventotwelve.join(",");
      const THeleventooneCSV = eleven.THeleventoone.join(",");
      const THeleventotwoCSV = eleven.THeleventotwo.join(",");
      const THeleventothreeCSV = eleven.THeleventothree.join(",");
      const THeleventofourCSV = eleven.THeleventofour.join(",");
      const THeleventofiveCSV = eleven.THeleventofive.join(",");

      const FeleventotwelveCSV = eleven.Feleventotwelve.join(",");
      const FeleventooneCSV = eleven.Feleventoone.join(",");
      const FeleventotwoCSV = eleven.Feleventotwo.join(",");
      const FeleventothreeCSV = eleven.Feleventothree.join(",");
      const FeleventofourCSV = eleven.Feleventofour.join(",");
      const FeleventofiveCSV = eleven.Feleventofive.join(",");

      this.setState({
        Meleventotwelve: MeleventotwelveCSV,
        Meleventoone: MeleventooneCSV,
        Meleventotwo: MeleventotwoCSV,
        Meleventothree: MeleventothreeCSV,
        Meleventofour: MeleventofourCSV,
        Meleventofive: MeleventofiveCSV,

        Televentotwelve: TeleventotwelveCSV,
        Televentoone: TeleventooneCSV,
        Televentotwo: TeleventotwoCSV,
        Televentothree: TeleventothreeCSV,
        Televentofour: TeleventofourCSV,
        Televentofive: TeleventofiveCSV,

        Weleventotwelve: WeleventotwelveCSV,
        Weleventoone: WeleventooneCSV,
        Weleventotwo: WeleventotwoCSV,
        Weleventothree: WeleventothreeCSV,
        Weleventofour: WeleventofourCSV,
        Weleventofive: WeleventofiveCSV,

        THeleventotwelve: THeleventotwelveCSV,
        THeleventoone: THeleventooneCSV,
        THeleventotwo: THeleventotwoCSV,
        THeleventothree: THeleventothreeCSV,
        THeleventofour: THeleventofourCSV,
        THeleventofive: THeleventofiveCSV,

        Feleventotwelve: FeleventotwelveCSV,
        Feleventoone: FeleventooneCSV,
        Feleventotwo: FeleventotwoCSV,
        Feleventothree: FeleventothreeCSV,
        Feleventofour: FeleventofourCSV,
        Feleventofive: FeleventofiveCSV
      });
    }
  }
...
CreateEleven.propTypes = {
  createEleven: PropTypes.func.isRequired,
